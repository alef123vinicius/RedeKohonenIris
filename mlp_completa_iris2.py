...
def main():
    ...
    nova_mat_entrada = pcaClassica(mat_entrada)
    ...
    pesos_obtidos = backpropagation(vet_arquitetura, matriz_pesos, mat_entrada_treino, mat_saida_treino, eta = 0.5, threshold = 0.05)
